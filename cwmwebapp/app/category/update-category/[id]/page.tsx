...
import {
  get_category_by_id,
  update_a_category,
} from "@/app/Services/Admin/category";
...
export default function Page({
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    ...
    const updatedData: Inputs = {
      _id: params.id,
      name:
        data.name !== catData?.categoryName ? data.name : catData?.categoryName,
      description:
        data.description !== catData?.categoryDescription
          ? data.description
          : catData?.categoryDescription,
      slug:
        data.slug !== catData?.categorySlug ? data.slug : catData?.categorySlug,
    };
